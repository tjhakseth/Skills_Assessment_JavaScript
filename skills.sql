...
--    from the Models and Brands tables.
    SELECT models.brand_name, models.name, headquarters 
...
-- left joins and inner joins.
    --Inner Joins, collects all the records that have matching columns on both tables.
    --Left Joins, collects all the records that have matching columns on the left table even if they don't match on the right table.
